...
Cashes = new Mongo.Collection("cash")
...
groupNames = ["white-group", "red-group", "green-group", "pink-group", "blue-group", "yellow-group", "orange-group", "turquoise-group", "fuschia-group"];
...
baseUsers = ["white-group-base", "red-group-base", "green-group-base", "pink-group-base", "blue-group-base", "yellow-group-base", "orange-group-base", "turquoise-group-base", "fuschia-group-base"];
