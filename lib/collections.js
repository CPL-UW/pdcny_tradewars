...
groupNames = ["red_group_1", "green_group_2", "pink_group_3", "blue_group_4", "mystic_group_5", "orange_group_6", "turqoise_group_7", "fuschia_group_8"];

// setTimeout(setInterval(Meteor.call('checkLogins'), 120000), 7000);

baseUsers = ["group-1-base", "group-2-base", "group-3-base", "group-4-base", "group-5-base", "group-6-base", "group-7-base", "group-8-base"];